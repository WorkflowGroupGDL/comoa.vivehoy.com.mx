        ...
        if(settings.selector != ''){
            ...
            if(element !=null){
                var chatBox = '<div class="ayoan_whatsapp_chatbox_container">' +
                    ...
                    '<img class="header-icon" src="./assets/img/whatsapp/whatsapp.svg"> </div><div class="col col-2">' +
                    ...
                    '<img class="icon" src="./assets/img/whatsapp/close.svg"></button></div></div>' +
                    '<div class="rs-openChatBtn widget-close-btn-row" >' +
                    '<button type="button" class="rs-openChatBtn widget-close-btn">' +
                    '<img class="icon" src="./assets/img/whatsapp/whatsapp.svg"></button></div></div>';
