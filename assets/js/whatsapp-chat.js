var whatsappchat = {
    ...
    multipleUser: function (options) {
        var defaultSettings = {
            users: [''],
            headerMessage: '¡No dudes en hacer cualquier pregunta!',
            chatBoxMessage: 'El equipo generalmente responde a la brevedad posible.',
            color: '#4ee676',
            selector: '',
        };
        var settings = { ...defaultSettings, ...options };
        if (settings.selector != '') {
            ...
            settings.users.forEach(function (user, index) {
                ...
                userList += '<li class="item rs-go-to-whatsapp ' + active + '" data-userId="' + index + '">' +
                    ...
                    '<img loading="lazy" alt="image" class="user-pro-pic" src="' + image + '" style="width:50px"></div></div><div class="col col-2">' +
            ...
            if (element != null) {
                var chatBox = '<div class="ayoan_whatsapp_chatbox_container">' +
                    ...
                    '<img loading="lazy" alt="image" class="header-icon" src="./assets/img/whatsapp/whatsapp.svg"> </div><div class="col col-2">' +
                    ...
                    '<img loading="lazy" alt="image" class="icon" src="./assets/img/whatsapp/close.svg"></button></div></div>' +
                    '<div class="rs-openChatBtn widget-close-btn-row" >' +
                    '<button type="button" class="rs-openChatBtn widget-close-btn">' +
                    '<img loading="lazy" alt="image" class="icon" src="./assets/img/whatsapp/whatsapp.svg"></button></div></div>';
